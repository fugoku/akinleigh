...
export default function SignUp() {
  return (
    <>
      <div className="bg-fill min-h-full flex flex-col justify-center pb-16 py-28 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h1 className="text-center mt-6 text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            <span className="text-primary">Sign </span> Up For{" "}
