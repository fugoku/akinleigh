...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div className=" mt-20 lg:mt-0 flex-col sm:flex-row mx-2 flex items-center my-10 justify-between" aria-label="Global">

        <div className="sm:flex sm:gap-x-5 mx-auto max-w-2xl">

          <div className="">
            <h1 className="text-2xl font-bold text-gray-900 md:text-4xl leading-loose">Build, Deploy and Scale your Application on the Cloud</h1>
      ...
      <div className="text-black gap-y-10 m-5 sm:gap-y-0 sm:gap-x-10 flex-wrap flex content-center items-center  justify-items-center sm:m-auto justify-center" aria-label="Global">
      ...
      {/* threes ends */}
      {/* make starts */}
      <div className="flex-col sm:flex-row gap-y-10 sm:gap-y-0 flex items-center sm:gap-x-10 justify-between py-48 px-10" aria-label="Global">
        <div className=" sm:flex sm:gap-x-5 mx-auto max-w-2xl">
      ...
      <div className="text-black m-auto sm:gap-x-10 gap-y-10 sm:m-5 sm:gap-y-0 flex-col sm:flex-row flex content-center items-center  justify-items-centersm:mx-10 justify-center" aria-label="Global">
        {/* <div className="flex-1 w-32 ..."> */}
