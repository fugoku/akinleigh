          ...
          <div>
            ...
            <div className="mt-20">
              ...
              <div className="mt-6 sm:max-w-xl">
                ...
                We'll help you get the most from your cloud experience
Harness Google’s top technology and culture of innovation with Google Cloud Consulting architects, engineers, delivery executives, trainers, partners, and other experts. We collaborate with our specialists to work alongside you to understand your business goals and help drive your cloud journey forward.
                </p>
              </div>
